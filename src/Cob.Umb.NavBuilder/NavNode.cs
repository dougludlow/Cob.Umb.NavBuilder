...
namespace Cob.Umb.NavBuilder
{
    class NavNode
    {
        ...
        public bool IsAncestor(NavNode node)
        {
            return Content.IsAncestor(node.Content);
        }
        ...
        public bool IsLast
        {
            get
            {
                return Parent == null || Index == Parent.ChildrenCount - 1;
            }
        }
